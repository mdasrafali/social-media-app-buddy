...
export default function CreatePostActionsDesktop({ onPost, posting, statusLabel, onImageSelect }) {
    ...
    <>
      ...
      <div className="_feed_inner_text_area_bottom">
        ...
        <div className="_feed_inner_text_area_btn">
          <button type="button" onClick={onPost} disabled={posting || !statusLabel} className="_feed_inner_text_area_btn_link">
            <svg
              className="_mar_img"
              xmlns="http://www.w3.org/2000/svg"
              width="14"
