...
export default function PostHeaderDropdown({ post, onPostDeleted, isOpen, onClose }) {
  const { user } = useAuth();
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      onPostDeleted(post._id); // then remove card from feed
    } catch (err) {
  ...
  return (
    <div
      id="_timeline_drop"
      className={`_feed_timeline_dropdown _timeline_dropdown${isOpen ? " show" : ""}`}
    >
