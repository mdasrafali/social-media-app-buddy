...
import { getCommentLikesApi } from '../../../api/commentApi'
import { usePaginatedList } from '../../../hooks/usePaginatedList'
import { getAvatar } from '../../../utils/avatar'

export default function CommentLikesModal({ commentId, onClose }) {
  const likesFetcher = useCallback(
    (cursor) =>
      getCommentLikesApi(commentId, cursor, 20).then(({ data }) => ({
