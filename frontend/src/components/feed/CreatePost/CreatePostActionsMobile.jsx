...
export default function CreatePostActionsMobile({ onPost, posting, statusLabel, onImageSelect }) {
      ...
      <div className="_feed_inner_text_area_bottom_mobile">
        <div className="_feed_inner_text_mobile">
          ...
          <div className="_feed_inner_text_area_btn">
            <button type="button" onClick={onPost} disabled={posting} className="_feed_inner_text_area_btn_link" style={{ opacity: posting ? 0.6 : 1 }}>
              <svg
                className="_mar_img"
                xmlns="http://www.w3.org/2000/svg"
                width="14"
